...
const char* WIFI_SSID = "GENARO";
const char* WIFI_PASSWORD = "balufe2022";
const char* RASPBERRY_IP = "192.168.1.145";
...
void tomarFoto() {
  ...
  HTTPClient http;
  String url = "http://" + String(RASPBERRY_IP) + ":" + RASPBERRY_PORT + "/disparar";
